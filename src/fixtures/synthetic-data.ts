...
export const TENANT_A_DERIVATION_RULES: readonly DerivationRuleSeed[] = [
  {
    ruleName: 'tardy-detention',
    conditionColumn: 'attendance_status',
    conditionValue: 'Tardy',
    derivedHoldType: 'Detention',
  },
  {
    ruleName: 'missing-id-detention',
    conditionColumn: 'missing_id',
    conditionValue: 'true',
    derivedHoldType: 'Detention',
  },
];
